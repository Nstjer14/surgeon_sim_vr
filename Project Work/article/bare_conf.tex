...
We need to write about the system and the scene - what does it do, and why does it do it
...
Two types of tests were performed, namely a usability test and an expert review with Jane Petersson and Johan Poulsen. These tests are a quantitative and a qualitative test respectively. The procedure is listed below:

\begin{itemize}
\item Participants are introduced to the system and the project
\item The participants are split up in different rooms
\item The participants perform the required tasks for an emergency undocking together
\item Usability test participants fill out questionnaires
\item A short exit interview is held
\end{itemize}

Three HTC Vive head mounted displays (HMDs) connected to a server hosted on computer A were used. Computer C is in a separate room from computer A and B. The specifications of these computers are shown in Table \ref{TAB:specs}. 
...
The questionnaires used in the usability test contain rating scales that rates different measures of the system complying to the System Usability Scale (SUS). These are shown in appendix XX. 
...
The script and transcript for the interview is shown in appendix XX.
