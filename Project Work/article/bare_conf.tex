...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Object}     & \textbf{Attributes}            & \textbf{Actions}                  \\ \hline
Video               & Title                          & Play/Pause/Zoom                   \\
                    & Duration                       & Fast Forward/Backward             \\
                    & Resolution                     & Take screenshot                   \\
                    & Embedded Audio Channels        & Draw on video (create annotation) \\
                    & Brightness                     & Insert embedded video             \\
                    & Embedded videos                &                                   \\ \hline
Annotation Overview & List of annotation frame start & Jump to frame                     \\ \hline
Annotation          & Audio clip                     & Create                            \\
                    & Visualization                  & Delete                            \\
                    & Frame start                    & Toggle show/hide                  \\
                    & Duration                       &                                   \\ \hline
Audio Channels      & Embedded Audio Clip            & Toggle channels                   \\ \hline
Embedded Video      & Video clips                    & Create \& place                   \\
                    &                                & Remove                            \\
                    &                                & Toggle sound                     \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|l|}
\hline
\textbf{Action}                        & \textbf{Metaphor-Based}       \\ \hline
Zoom                                   & Oversized touchscreen zooming \\
Select annotation to jump to from menu & Swiping pictures on a phone   \\
Place embedded video                   & Drag and drop                 \\
Draw on video                          & Point and drag                \\
Select draw annotation color           & Select color from palette     \\
Record voice annotation                & Using voice recorders         \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|l|l|}
\hline
\textbf{Concepts} & \textbf{Relation}               \\ \hline
User              & Owns the videos and audio       \\
                  & Creates and own annotations     \\ \hline
Video             & Contain annotations             \\
                  & Each video belong to a folder   \\
                  & Has a owner (the user)          \\
                  & Statistics                      \\ \hline
Annotations       & Audio clips                     \\
                  & Drawings                        \\
                  & Combined                        \\
                  & Belong to a video               \\
                  & Conveys information to the user \\ \hline
Screenshot        & Belong to annotation            \\ \hline
\end{tabular}
\end{table}
What does it mean
