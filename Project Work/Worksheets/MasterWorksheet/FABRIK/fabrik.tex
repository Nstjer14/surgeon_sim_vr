...
\begin{figure}[hbtp]
\begin{subfigure}
\includegraphics[width=0.48\textwidth]{Robot_state1.PNG}
\caption{The robot and its bones in one state with the target visible}
\end{subfigure} \begin{subfigure}
\includegraphics[width=0.48\textwidth]{Robot_state2.PNG}
...
\begin{figure}[hbtp]
\centering
\includegraphics[width=\textwidth]{Robot_OutOfReach.PNG}
