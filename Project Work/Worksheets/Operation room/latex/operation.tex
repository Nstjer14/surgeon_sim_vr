...
\begin{figure}[hbpt]
	...
	\caption{Figure showing the endoscopic camera up close}
	\label{fig:cam_close}
\end{figure}
...
\begin{figure}[hbpt]
	...
	\caption{Figure showing one of the ports used to insert the tools in the patient}
	\label{fig:port}
\end{figure}
...
\begin{figure}[hbpt]
	...
	\caption{Figure showing the tools used with the robot}
	\label{fig:tools}
\end{figure}
