...
[eigvalue, eigvector] = pca(trainingdata,2); %returns coefficiens and vectors 

%Reducing dimensions of test data / Projecting
...
for ii=1:length(testY)
    largest = max([evalFive(ii),evalSix(ii),evalEight(ii)]);
